...
src/UniColor/               domain
  c_api.nim                 C ABI
include/UniColor.h          hand-written C header
tests/test_version.nim      Nim tests
tests/c/                    C ABI test (links the header against the lib)
examples/                   Nim + C demos
py/                         Cython binding + pytest
ADRs/                       0001 sibling deps, 0002 license, 0003 C ABI/Python,
                             0004 error model, 0005 WASM
